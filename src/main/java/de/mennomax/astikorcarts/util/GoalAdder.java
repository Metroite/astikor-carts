 ...
 * <p>This is notably an issue with {@link net.minecraft.world.entity.animal.horse.SkeletonHorse}, as it uses a goal
 * {@link net.minecraft.world.entity.animal.horse.SkeletonTrapGoal} which depends on being the last goal and when otherwise causes a
...
public final class GoalAdder<T extends Entity> {
    ...
    private Set<WrappedGoal> getGoals(final T entity) {
        try {
            return (Set<WrappedGoal>) GOALS.get(this.selector.apply(entity));
